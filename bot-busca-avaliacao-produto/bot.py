...
def main():
    ...
    if not bot.find("super-ofertas", matching=0.97, waiting_time=10000):
        not_found("super-ofertas")
    bot.click()
    
    avaliacao = bot.find_elements(selector='wd-product-rating',by=By.CLASS_NAME)
